...

{
  ...
  if (piVar1[2] != 0) {
    ...
    if (piVar1[2] != 0) goto LAB_1800065c9;
  }
  ...
  if (cVar3 != '\0') {
    do {
      ...
      *(undefined4 *)(lVar5 + 0xc) = 0;
      if ((!bVar2) || (cVar3 = FUN_180001b20(piVar1), cVar3 == '\0')) break;
    } while( true );
  }
    ...
    if (cVar5 != '\0') {
      do {
        ...
        if (*(int *)(lVar9 + 4) == 0) {
          ...
          if ((cVar5 == '\0') || (cVar5 = FUN_180001b20(piVar2), cVar5 == '\0')) break;
        }
        ...
        if (uVar11 == 0xc) {
          if ((int)uVar13 < local_1878) {
            ...
            if ((int)uVar13 < iVar6) goto LAB_180006a65;
          }
...
LAB_180006a65:
        ...
        *(undefined4 *)(lVar9 + 8) = 0;
        if ((!bVar3) || (cVar5 = FUN_180001b20(piVar2), uVar11 = local_187c, cVar5 == '\0')) break;
      } while( true );
    }
  }
...

{
  ...
  while (DVar3 == 0) {
    if (*param_1 != '\0') goto LAB_180001716;
    ...
    *(undefined4 *)(DAT_1800139e8 + 0x1c15c) = 1;
    ...
    DAT_1800139f8 = 1;
    if (iVar2 == 0) {
      (**(code **)(*(longlong *)(*(longlong *)(DAT_18000d8b8 + 0x18) + 0x10) + 0x6f8))
                (*(longlong *)(DAT_18000d8b8 + 0x18),0,0,1);
    }
    DVar3 = WaitForMultipleObjects(2,&pvStack67640,0,0xffffffff);
  }
  if (*param_1 == '\0') {
...
void FUN_180001740(undefined8 param_1,undefined4 param_2,void *param_3,int param_4,void *param_5,
                  int param_6)

{
  ...
  if (0x10000 < (ulonglong)(longlong)param_4) {
    local_848 = strrchr("h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp",0x5c);
    if (local_848 == (char *)0x0) {
      local_848 = "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp";
    }
    else {
      local_848 = local_848 + 1;
    }
    local_840 = 0xa6;
    snprintf(local_828,0x3ff,"%s %s:%d","len <= sizeof(g_pPipeMemHead->serialToGuest.buf)");
    local_429 = 0;
...
LAB_180001ccb:
    ...
    if (DAT_1800139d8 != '\0') goto LAB_180001ccb;
    if (iVar3 == 10) {
      SwitchToThread();
    }
    iVar1 = 0;
    ...
    do {
      if (uVar10 < uVar9) {
        ...
        do {
          ...
          if (((uint)puVar4[4] < (uint)puVar2[4]) || ((uint)puVar4[4] <= (uint)puVar2[4])) break;
    ...
    do {
      ...
      if (0x18 < uVar9) {
        ...
        do {
          ...
          if (((uint)puVar5[4] < (uint)puVar4[4]) || ((uint)puVar5[4] <= (uint)puVar4[4])) break;
...

{
  ...
  if (0x3fe < iVar1 - 1U) {
    ...
    if (0x3fe < iVar1 - 1U) goto LAB_180003560;
  }
    ...
    if (param_1[1] == DAT_1800139e8[lVar6 * 0xc + 0xb]) {
      while( true ) {
        ...
        if (((DVar5 != 0) || (DAT_1800139d8 != '\0')) ||
           (param_1[1] != DAT_1800139e8[lVar6 * 0xc + 0xb])) goto LAB_180003531;
        ...
        EnterCriticalSection((LPCRITICAL_SECTION)&DAT_18000d848);
        if (param_1[1] != DAT_1800139e8[lVar6 * 0xc + 0xb]) break;
      }
    }
    LeaveCriticalSection((LPCRITICAL_SECTION)&DAT_18000d848);
LAB_180003531:
...

{
  ...
  if (0x3fe < iVar3 - 1U) {
    ...
    if (0x3fe < iVar3 - 1U) goto LAB_180003bbd;
  }
...

{
  ...
  lVar1 = DAT_18000d8b8;
  *in_R9 = 1;
  (**(code **)(*(longlong *)(*(longlong *)(lVar1 + 0x18) + 0x10) + 0x6f8))
            (*(longlong *)(lVar1 + 0x18),0,0,0);
  DAT_1800139f8 = 0;
  return 0;
}
...

{
  ...
  if (param_4 == 0xffffffffffffffff) {
    uVar1 = (**(code **)(*(longlong *)(param_1 + 0x10) + 0x18))
                      (param_1,**(undefined8 **)(param_1 + 0x18));
    if (-1 < (int)uVar1) {
      return uVar1;
    }
    lVar2 = RTLogRelGetDefaultInstanceEx(0x200010);
    if (lVar2 == 0) goto LAB_180004991;
    uVar3 = 0x454;
  }
  else {
    uVar1 = (**(code **)(*(longlong *)(param_1 + 0x10) + 0x10))
                      (param_1,**(undefined8 **)(param_1 + 0x18),param_4 & 0xffff);
    if (-1 < (int)uVar1) {
      return uVar1;
    }
    lVar2 = RTLogRelGetDefaultInstanceEx(0x200010);
  ...
  RTLogLoggerEx(lVar2,0x10,0x20,"AssertLogRel %s(%d) %s: %s\n",
                "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp",uVar3,
                "int __cdecl myIOPortRegionMap(struct PDMDEVINSR3 *,struct PDMPCIDEV *,unsigned int,unsigned __int64,unsigned __int64,enum PCIADDRESSSPACE)"
                ,"RT_SUCCESS_NP(rc)");
LAB_180004991:
  lVar2 = RTLogRelGetDefaultInstanceEx(0x200010);
  if (lVar2 != 0) {
    RTLogLoggerEx(lVar2,0x10,0x20,"%Rra\n",
...
void FUN_180004ce0(undefined8 param_1,undefined8 param_2,undefined8 param_3,undefined8 param_4)

{
  ...
  lVar2 = RTErrInfoAlloc(0x100);
  pcVar3 = (char *)RTPathJoinA(DAT_18000d840,param_1);
  iVar1 = RTLdrLoadEx(pcVar3,local_438,0,lVar2);
  if (iVar1 < 0) {
    lVar4 = RTLogRelGetDefaultInstanceEx(0x200010);
    if (lVar4 != 0) {
      local_440 = *(char **)(lVar2 + 0x10);
      pcVar8 = "fastpipe: load host failed path=%s, err=%s\n";
      local_448 = pcVar3;
      goto LAB_180004d8f;
    }
  }
  else {
    lVar4 = RTLogRelGetDefaultInstanceEx();
    if (lVar4 != 0) {
      pcVar8 = "fastpipe: load host successs mod=%p, path=%s\n";
      local_448 = local_438[0];
      local_440 = pcVar3;
LAB_180004d8f:
      RTLogLoggerEx(lVar4,0x10,0x20,pcVar8);
    }
  }
  RTStrFree(pcVar3);
  RTErrInfoFree(lVar2);
  pcVar3 = local_438[0];
  if (local_438[0] == (char *)0x0) {
    local_448 = strrchr("h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp",0x5c);
    if (local_448 == (char *)0x0) {
      local_448 = "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp";
    }
    ...
    local_440 = (char *)CONCAT44(local_440._4_4_,0x4c4);
    snprintf(local_428,0x3ff,"%s %s:%d",&DAT_1800093dc);
    local_29 = 0;
    MessageBoxA((HWND)0x0,local_428,"Error",0);
  }
  else {
    pcVar5 = (code *)RTLdrGetFunction(local_438[0],"OnLoad");
    if (pcVar5 == (code *)0x0) {
      lVar2 = RTLogRelGetDefaultInstanceEx(0x200010);
      if (lVar2 != 0) {
        local_440 = "OnLoad";
        local_448 = pcVar3;
        RTLogLoggerEx(lVar2,0x10,0x20,"fastpipe: GetFunctionAddr failed mod=%p, lpszFuncName=%s\n");
      }
      local_448 = strrchr("h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp",0x5c);
      if (local_448 == (char *)0x0) {
        local_448 = "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp";
      ...
      local_440 = (char *)CONCAT44(local_440._4_4_,0x4bf);
      snprintf(local_428,0x3ff,"%s %s:%d",&DAT_1800093dc);
      local_29 = 0;
      MessageBoxA((HWND)0x0,local_428,"Error",0);
    }
    else {
      lVar2 = RTLogRelGetDefaultInstanceEx();
      if (lVar2 != 0) {
        local_440 = "OnLoad";
        local_448 = pcVar3;
        RTLogLoggerEx(lVar2,0x10,0x20,"fastpipe: GetFunctionAddr success mod=%p, lpszFuncName=%s\n")
        ;
      }
      local_448 = (char *)local_438;
      local_438[0] = (char *)0x0;
      (*pcVar5)(DAT_1800139c0,0x10000,param_4,FUN_1800019b0);
      if (local_438[0] != (char *)0x0) {
        if (DAT_18000d078 != 0) {
          plVar6 = &DAT_18000d078;
          uVar7 = 0;
          do {
            uVar7 = uVar7 + 1;
            plVar6 = plVar6 + 1;
          } while (*plVar6 != 0);
          if (0xe < uVar7) goto LAB_180004e80;
        }
        (&DAT_18000d078)[(int)uVar7] = (longlong)local_438[0];
      }
    }
  }
LAB_180004e80:
...

{
  ...
  if (lVar1 != 0) {
    in_stack_ffffffffffffffd8 = "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp";
    RTLogLoggerEx(lVar1,0x10,0x20,"AssertLogRel %s(%d) %s: %s\n",
                  "h:\\gpu\\fastpipe-6.1.36\\fastpipeapi.cpp",0x575,
                  "int __cdecl VBoxDevicesRegister(struct PDMDEVREGCB *,unsigned int)",
                  "pCallbacks->u32Version == PDM_DEVREG_CB_VERSION");
  }
  lVar1 = RTLogRelGetDefaultInstanceEx();
  if (lVar1 != 0) {
    RTLogLoggerEx(lVar1,0x10,0x20,"%#x, expected %#x\n",
...

{
  ...
  for (pIVar3 = &IMAGE_SECTION_HEADER_180000208; pIVar3 != (IMAGE_SECTION_HEADER *)&DAT_1800002f8;
    ...
    if (((ulonglong)(uint)pIVar3->VirtualAddress <= param_1 - 0x180000000U) &&
       ...
       param_1 - 0x180000000U < uVar1)) goto LAB_180007423;
  }
...

{
  ...
  if (((DAT_18000d010 ^ _DAT_18000d7d8) >> bVar2 | (DAT_18000d010 ^ _DAT_18000d7d8) << 0x40 - bVar2)
      == 0xffffffffffffffff) {
    iVar1 = _crt_atexit();
  }
  else {
